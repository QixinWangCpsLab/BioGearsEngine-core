...
namespace biogears {
  ...
  SEScalarWithTimeStamp::SEScalarWithTimeStamp() : SEScalar() {}

  SEScalarWithTimeStamp::SEScalarWithTimeStamp(double v, double ts, bool ro)
    : SEScalar(v, ro)
  {
    SetValue(v);
    SetTimeStamp(ts);
  ...
  void SEScalarWithTimeStamp::SetTimeStamp(double ts)
  {
    m_timeStamp_s = ts;
  }
